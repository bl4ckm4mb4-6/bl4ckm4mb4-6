...
- **System Resource Monitor**: A Python-based utility for real-time monitoring of CPU, RAM, Disk and GPU, optimized and compiled into a standalone executable.
- **Flappy Bird**: A Python implementation of the classic game using Pygame, focusing on high-performance collision logic and state management.

## 🛡️ Cybersecurity Journey
I'm currently teaching myself the art of ethical hacking. My focus is on analyzing vulnerabilities with a hybrid approach, combining Red Team and Blue Team methodologies to ensure maximum software security.
